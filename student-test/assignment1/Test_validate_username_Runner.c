...
int Test_validate_username_main(void)
{
  UnityBegin("/home/nnagdy/advanced_embdedded_linux/assignments/assignment1/aesd-assignments/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
